...
/// 1. The executor will pass this pub struct to VM at the end of a block proposal.
/// 2. The VM will use this pub struct to create a special system transaction that will emit an event
